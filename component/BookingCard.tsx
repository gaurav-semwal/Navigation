  ...
  return (
    <View style={styles.main}>
      <View style={styles.headerContainer}>
        <Text style={styles.bookingDate}>Booking on - {date}</Text>
        <Text style={styles.bookingId}>Booking ID- {id}</Text>
      </View>
      <View style={styles.detailsContainer}>
        <Text style={styles.detailsLeft}>
          {people} Adults - {nights} nights
        </Text>
        <Text style={styles.detailsRight}>Payment received - ₹{payment}</Text>
      </View>
      <View style={styles.roomTypeContainer}>
        <Text style={styles.detailsLeft}>{roomType} Room</Text>
      </View>
